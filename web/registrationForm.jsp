                        ...
                        <div class="col-6">
                            <form method="post">
                                ...
                                <div class="col-4 login_menubar">
                                    ...
                                    <a href="forgotPassForm.jsp">Forgotten account?</a>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <form method="post">
                                    ...
                                    <div>
                                        <span style="color: gray; font-weight: bold;"><a style="color: rgb(16, 68, 179); cursor: pointer;">Create a Page</a> for a celebrity, band or business.</span>
                                    </div>
                                </form>
                            </div>
